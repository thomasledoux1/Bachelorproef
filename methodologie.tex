...
\begin{figure}[h]
	...
	\includegraphics[width=10cm, height=10cm, keepaspectratio]{img/ScreenShotVoice}\\[.5cm]
	\centering
\end{figure}
\begin{figure}[h]
	\caption{\textit{Resultaat van spraakherkenning}}
	\includegraphics[width=10cm, height=10cm, keepaspectratio]{img/ScreenShotVoiceRecognized}\\[.5cm]
	\centering
\end{figure}
