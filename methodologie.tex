...
\begin{figure}[H]
	...
	\includegraphics[width=7cm, height=7cm, keepaspectratio]{img/ScreenShotVoice}\\[.5cm]
\end{figure}
\begin{figure}[H]
	\centering
	\caption{\textit{Resultaat van spraakherkenning}}
	\includegraphics[width=7cm, height=7cm, keepaspectratio]{img/ScreenShotVoiceRecognized}\\[.5cm]
